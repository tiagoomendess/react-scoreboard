...
class Matches extends React.Component<IProps, IState> {
    ...
    render() {
        return (<div className="matches">
            ...
            <p  hidden={this.state.isLoading} className='flow-text center mb-20'>A controlar o placard {this.state.code}</p>
            ...
            <small className="center" hidden={this.state.isLoading}> Apenas aparecem os jogos de hoje. Para fazer testes utilize sempre o último jogo da lista.</small>
        </div>)
    }
}
